  ...
  # added by Chang, Here I used the 1,2,3,4-gram as features's based, but I don't rename to 1234gram.vocab
  # just for convience and least change with correctness check and get quick results
  ...
  $cnn_exe $gpumem cnn \
         ...
         data_ext0=nbw3 data_ext1=p3 data_ext2=p4 data_ext3=p5 \
...
### add by Chang, add I said previously, need to add nodes3=1000, and also 3nodes=$nodes3, 3resnorm_width=$nodes3, also change to my param file seq2-bown-my.param
