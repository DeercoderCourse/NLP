...
#  sdir=output    # <=   output/ if generated by semisup-rcv1-{unsup|unsup3|parsup}-tv.sh. 
  ...
  #---  Step 1. Generate input files. 
  xszk=30
  xvoc1=data/rcv1${z}-1m-trn.vocab  # This must be the same as semisup-rcv1-{unsup|unsup3|parsup}-tv.sh 
  $prep gen_vocab input_fn=${rcv1dir}/rcv1-1m-train.txt.tok vocab_fn=$xvoc1 $options WriteCount \
  ...
  xvoc3=data/rcv1${z}-trn-123gram-${xszk}k.vocab  # This must be the same as semisup-rcv1-unsup3-tv.sh 
