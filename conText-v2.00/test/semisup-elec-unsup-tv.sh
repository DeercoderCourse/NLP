  #####
  #####  Elec: unsup-tv.  tv-embedding learning with unsupervised target. 
  #####
  ...
  logfn=log_output/elec-uns-dim${dim}.log
  echo 
  ...
  logfn=log_output/elec-uns-sup-dim${dim}.log
  perffn=perf/elec-uns-sup-dim${dim}.csv
