...
/*------------------------------------------------*/
void AzPmatApp::activate_th(AzPmat *mm, 
                            double th, 
                            AzPmat *m_deriv) const
{                            
  if (m_deriv == NULL) {
    a._activate_th(mm->_dptr_u(), mm->size(), (AzFloat)th);   
  }
  else {
...
/*------------------------------------------------*/
void AzPmatApp::activate_log(AzPmat *mm, 
                             AzPmat *m_deriv) const
{
  if (m_deriv == NULL) {
    a._activate_log(mm->_dptr_u(), mm->size()); 
  }
  else {
...
/*------------------------------------------------*/
void AzPmatApp::activate_tanh(AzPmat *mm, 
                              AzPmat *m_deriv) const
{
  if (m_deriv == NULL) {
    a._activate_tanh(mm->_dptr_u(), mm->size()); 
  }
  else {
...
/*------------------------------------------------*/
void AzPmatApp::activate_softplus(AzPmat *mm, 
                              AzPmat *m_deriv) const
{
  if (m_deriv == NULL) {
    a._activate_softplus(mm->_dptr_u(), mm->size()); 
  }
  else {
...
/*------------------------------------------------*/
void AzPmatApp::truncate(AzPmat *mm, 
                         double border, 
                         AzPmat *m_deriv) const
{
  AzX::throw_if((border <= 0), "AzPmatApp::truncate", "border must be positive"); 
  if (m_deriv == NULL) {
    a._truncate(mm->_dptr_u(), mm->size(), (AzFloat)border); 
  }
  else {
...
void AzPmatApp::unpooling_max(AzPmat *m1, 
                              ...
                              const AzPintArr2 *pia2_col1to2) /* [col1] col2_1, col2_2, ... */
const
{
